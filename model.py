...
def simulate_energy(time_periods, mynetwork, my_tariffs, results, status_callback=None):
...
def simulate_financial(time_periods, mynetwork, my_tariffs, results, status_callback):
