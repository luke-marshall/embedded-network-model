...
class Results():
	...
	def get_local_solar_import(self, time, participant_id):
		self.data_output["df_local_solar_import"].loc[time, participant_id]

	def set_participant_central_batt_import(self, time, participant_id, value):
		self.data_output["df_participant_central_batt_import"].loc[time, p] = value
	def get_participant_central_batt_import(self, time, participant_id):
		return self.data_output["df_participant_central_batt_import"].loc[time, p]
	...
	def get_local_solar_sales(self, time, participant_id, value):
	...
	def get_central_battery_export(self, time):
		return data_output['df_network_energy_flows'].loc[time, 'central_battery_export']
	...
	def get_gross_participant_grid_import(self, time):
		return data_output["df_network_energy_flows"].loc[time, 'gross_participant_grid_import']
	...
	def get_gross_participant_local_solar_import(self, time):
		return data_output["df_network_energy_flows"].loc[time, 'gross_participant_local_solar_import']
	...
	def get_gross_participant_central_battery_import(self, time):
		return data_output["df_network_energy_flows"].loc[time, 'gross_participant_central_battery_import']
